...
This module covers VNet, Subnets, Peering, DNS and provides hands-on lab experience with Azure services.
...
### Content Section
- **Theory & Concepts** - Deep dive into Virtual Networking
...
- **Lab Exercises** - 4 exercises hands-on tasks
- **Expected Outputs** - Success criteria for each exercise

### Resources Section
- **PowerShell Commands** - 50+ commands for Virtual Networking
...
1. Understand Virtual Networking architecture and components
2. Configure Virtual Networking resources in Azure
...
- **Exercise 04.1:** Basic setup and configuration
- **Exercise 04.2:** Advanced features
- **Exercise 04.3:** Performance optimization
- **Exercise 04.4:** Monitoring and troubleshooting

See LAB-4 exercises.md for detailed step-by-step instructions.
...
3. Complete LAB-4 exercises.md step by step
...
- **Before:** Complete Modules 1-3
- **After:** Proceed to Module 5
...
- [ ] Read theory content
- [ ] Completed all 4 exercises exercises
