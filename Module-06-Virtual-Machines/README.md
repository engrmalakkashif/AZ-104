...
This module covers VM creation, Image gallery, Extensions and provides hands-on lab experience with Azure services.
...
### Content Section
- **Theory & Concepts** - Deep dive into Virtual Machines
...
- **Lab Exercises** - 5 exercises hands-on tasks
- **Expected Outputs** - Success criteria for each exercise

### Resources Section
- **PowerShell Commands** - 50+ commands for Virtual Machines
...
1. Understand Virtual Machines architecture and components
2. Configure Virtual Machines resources in Azure
...
- **Exercise 06.1:** Basic setup and configuration
- **Exercise 06.2:** Advanced features
- **Exercise 06.3:** Performance optimization
- **Exercise 06.4:** Monitoring and troubleshooting

See LAB-5 exercises.md for detailed step-by-step instructions.
...
3. Complete LAB-5 exercises.md step by step
...
- **Before:** Complete Modules 1-5
- **After:** Proceed to Module 7
...
- [ ] Read theory content
- [ ] Completed all 5 exercises exercises
